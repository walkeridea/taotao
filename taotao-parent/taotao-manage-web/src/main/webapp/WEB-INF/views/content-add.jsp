...
<link type="text/css" rel="stylesheet" href="${prc}/js/kindeditor-4.1.10/themes/default/default.css">
<script type="text/javascript" charset="utf-8" src="${prc}/js/kindeditor-4.1.10/kindeditor-all-min.js"></script>
<script type="text/javascript" charset="utf-8" src="${prc}/js/kindeditor-4.1.10/lang/zh_CN.js"></script>
	...
	<form id="contentAddForm" class="itemForm" method="post">
	    ...
	    <table cellpadding="5">
	        ...
	        <tr>
	            <td>内容:</td>
	            <td>
	                <textarea title="内容" style="width:800px;height:300px;visibility:hidden;" name="content"></textarea>
	            </td>
	        </tr>
	    </table>
	</form>
