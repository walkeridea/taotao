...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <link type="text/css" rel="stylesheet"  href="http://static.taotao.com/css/order-commons.css" source="widget"/>
	<script type="text/javascript" src="http://static.taotao.com/js/jquery-1.6.4.js"></script>
	<script type="text/javascript" src="http://static.taotao.com/js/base.js"></script>
...
<!-- footer end -->
	<script type="text/javascript" src="http://static.taotao.com/js/json2.js"></script>
	<script type="text/javascript" src="http://static.taotao.com/js/payAndShipment.js"></script>
	<script type="text/javascript" src="http://static.taotao.com/js/order2.js"></script>
	</body>
</html>