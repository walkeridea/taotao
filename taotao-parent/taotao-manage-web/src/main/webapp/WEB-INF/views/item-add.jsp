...
<link href="${prc}/js/kindeditor-4.1.10/themes/default/default.css" type="text/css" rel="stylesheet">
	...
	<form id="itemAddForm" class="itemForm" method="post">
	    <table cellpadding="5">
	        ...
	        <tr>
	            <td>商品描述:</td>
	            <td>
	                <textarea title="商品描述" style="width:800px;height:300px;visibility:hidden;" name="desc"></textarea>
	            </td>
	        </tr>
